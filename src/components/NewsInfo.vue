<template>
  <div>
    <el-drawer title="新闻信息" size='75%' :visible.sync="infoVisible" @open="handleOpen" :wrnewserClosable="false"
          ...
          <div class="edit-container">
            <el-row :gutter="30">
              <el-col :span="15">
                ...
                <div style="font-size: 17px;font-weight: 600;margin-bottom: 10px;">新闻描述：</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getCateOptions() {
        newsCategoryOptions().then(response => {
